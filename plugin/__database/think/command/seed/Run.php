...
namespace plugin\__database\think\command\seed;

use  plugin\__database\phinx\seed\SeedInterface;
use think\console\Input;
use think\console\input\Option as InputOption;
use think\console\Output;
use  plugin\__database\think\command\Seed;
